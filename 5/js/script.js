...
const animationTitle = new _modules_accent_typography__WEBPACK_IMPORTED_MODULE_9__["default"](`.intro__title`, 600, `active-animation`, `transform`, 100, 30, false);
animationTitle.runAnimation();

const animationDate = new _modules_accent_typography__WEBPACK_IMPORTED_MODULE_9__["default"](`.intro__date`, 400, `active-animation`, `transform`, 500, 20, true);
animationDate.runAnimation();

const sliderTitle = new _modules_accent_typography__WEBPACK_IMPORTED_MODULE_9__["default"](`.slider__item-title`, 600, `active-animation`, `transform`, 0, 30, true);
sliderTitle.runAnimation();

const prizesTitle = new _modules_accent_typography__WEBPACK_IMPORTED_MODULE_9__["default"](`.prizes__title`, 600, `active-animation`, `transform`, 0, 30, true);
prizesTitle.runAnimation();

const rulesTitle = new _modules_accent_typography__WEBPACK_IMPORTED_MODULE_9__["default"](`.rules__title`, 600, `active-animation`, `transform`, 0, 30, true);
rulesTitle.runAnimation();

const gameTitle = new _modules_accent_typography__WEBPACK_IMPORTED_MODULE_9__["default"](`.game__title`, 600, `active-animation`, `transform`, 0, 30, true);
